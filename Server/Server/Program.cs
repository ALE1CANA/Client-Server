...
namespace ProtocolloTcp
{
    class Server
    {
        private static readonly string[] AllQuestions =
        {
            ...
            "Qual e' la prima squadra di Roma?",
            "Come si chiama il presidente della repubblica (cognome)?",
            "Chi ha vinto il mondiale nel 2006? ",
            "Quanto fa 123456789*0?"
        };
            ...
            try
            {
                ...
                while (true)
                {
                    ...
                    try
                    {
                        ...
                        {
                            Console.WriteLine("Client non partecipare al quiz. Chiudo connessione.");
